...
{% include button.html button_name="Find out more" button_class="info" url="/research" %} {% include button.html button_name="Get in touch" button_class="primary" url="contact" %}</div>